...
def main():
    ...
    parser.add_argument('--c0_train', default='../../data/nonhaters_en.tok.txt')
    parser.add_argument('--c1_train', default='../../data/haters_en.tok.txt')
    parser.add_argument('--c0_eval', default='../../data/nonhaters_en.tok.txt')
    parser.add_argument('--c1_eval', default='../../data/haters_en.tok.txt')
